package com.kinoko2k.call56customdeathmessages.commands;
...
public class Call56CustomDeathMessagesCommand implements CommandExecutor, TabCompleter
{

    private Call56CustomDeathMessages plugin;

    public Call56CustomDeathMessagesCommand (Call56CustomDeathMessages plugin)
    {
        this.plugin = plugin;
    }
