...
public class SkullCreator {
     ...
     * @return The head of the Player.
     */
    public static ItemStack itemFromUuid(UUID id, Call56CustomDeathMessages plugin) {
     ...
     * @return The head of the Player.
     */
    public static ItemStack itemWithUuid(ItemStack item, UUID id, Call56CustomDeathMessages plugin) {
        notNull(item, "item");
        notNull(id, "id");
